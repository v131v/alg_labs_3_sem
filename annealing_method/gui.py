...
class App:
    def __init__(
        ...
        title: str,
        handler: Callable[
            [int, list[Tuple[int, int, float]], float],
        ...
        self.from_label = ttk.Label(
            self.frame, text="From:", foreground=light, background=dark
        )
        ...
        self.to_label = ttk.Label(
            self.frame, text="To:", foreground=light, background=dark
        )
        self.to_label.pack()
        ...
        self.weight_label = ttk.Label(
            self.frame, text="Weight:", foreground=light, background=dark
        )
        ...
        self.tempr_label = ttk.Label(
            self.frame2, text="Tempreture: 0", foreground=light, background=dark
        )
        self.tempr_label.pack()
        ...
        self.scale1 = ttk.Scale(
            ...
            to=0,
            orient="vertical",
            command=self.upd_tempreture,
        )
        self.scale1.pack(fill="y", expand=True)
